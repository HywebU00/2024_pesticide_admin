  ...
  $(window).on('load scroll', function () {
    ...
    if ($(window).scrollTop() + contentH > blockHeight && blockHeight > contentH) {
      $('.publish_block')
        ...
        .stop()
        .delay(200)
        .animate({ top: $(window).scrollTop() + contentH - blockHeight }, 800, 'easeOutQuint');
...
$('.font_size')
  ...
  .click(function (e) {
    ...
    $('.content').removeClass('large_size').addClass('small_size');
...
$('.font_size')
  ...
  .click(function (e) {
    $(this).parent('li').siblings('li').find('a').removeClass('active');
    $('.content').removeClass('large_size small_size');
    $(this).blur().addClass('active');
    e.preventDefault();
...
$('.font_size')
  ...
  .click(function (e) {
    $(this).parent('li').siblings('li').find('a').removeClass('active');
    $('.content').removeClass('small_size').addClass('large_size');
    $(this).blur().addClass('active');
    e.preventDefault();
...
window.onload = function (e) {
  ...
  if (cookie == 'small') {
    ...
    $('.content').removeClass('large_size medium_size').addClass('small_size');
    ...
    if (cookie == 'large') {
      ...
      $('.content').removeClass('small_size medium_size').addClass('large_size');
